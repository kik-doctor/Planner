...
// types
import type { IEmailCheckData, IEmailCheckResponse } from "@planner/types";
// services
import { APIService } from "../api.service";

/**
 * Service class for handling authentication-related operations for planner space application
