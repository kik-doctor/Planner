...
This package is part of the Planner workspace and can be used by adding it to your project's dependencies:

```json
{
  "dependencies": {
    "@planner/decorators": "workspace:*"
  }
}
```
...
```typescript
import { Controller, Get, Post, BaseController } from "@planner/decorators";
...
```typescript
import { Controller, WebSocket, BaseWebSocketController } from "@planner/decorators";
