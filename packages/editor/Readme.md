...
The `@planner/editor` package serves as the foundation for our editor system. It provides the base functionality for our other editor packages, but it will not be used directly in any of the projects but only for extending other editors.
...
1. useEditor - A hook that you can use to extend the Planner editor.
