export default {
  ...
  support: "支援",
  discord: "Discord",
  powered_by_planner_pages: "由 Planner Pages 提供",
  ...
  home: {
    empty: {
      ...
      create_project: {
        title: "建立專案",
        description: "Planner 中的大多數事情都始於一個專案。",
        cta: "開始使用",
      },
      invite_team: {
        title: "邀請您的團隊",
  ...
  workspace_creation: {
    heading: "建立您的工作區",
    subheading: "若要開始使用 Planner，您需要建立或加入工作區。",
    form: {
      name: {
        label: "為您的工作區命名",
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        title: "您的專案、活動和指標概覽",
        description:
          "歡迎使用 Planner，我們很高興您在這裡。建立您的第一個專案並追蹤您的工作事項，這個頁面將會變成一個協助您進展的空間。管理員也會看到協助他們團隊進展的項目。",
        primary_button: {
          text: "建立您的第一個專案",
          comic: {
            title: "在 Planner 中，一切都始於專案",
  ...
  workspace_settings: {
    ...
    key_created: "金鑰已建立",
    copy_key: "複製並儲存此金鑰到 Planner Pages。關閉後您將無法看到此金鑰。已下載包含金鑰的 CSV 檔案。",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          title: "刪除 API 權杖",
          description: "使用此權杖的任何應用程式將無法再存取 Planner 資料。此操作無法復原。",
          success: {
            title: "成功！",
            message: "API 權杖已成功刪除",
          },
    ...
    empty_state: {
      api_tokens: {
        title: "尚未建立 API 權杖",
        description: "Planner API 可用於將您在 Planner 中的資料與任何外部系統整合。建立權杖以開始使用。",
      },
      webhooks: {
        title: "尚未新增 Webhook",
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        title: "尚無活動",
        description: "開始建立新工作事項！為其新增詳細資訊和屬性。探索更多 Planner 功能以檢視您的活動。",
      },
      assigned: {
        title: "沒有指派給您的工作事項",
        description: "從這裡可以追蹤指派給您的工作事項。",
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        title: "自動封存已關閉的工作項目",
        description: "Planner將自動封存已完成或已取消的工作項目。",
        duration: "自動封存已關閉的工作項目",
      },
      "auto-close": {
        title: "自動關閉工作項目",
        description: "Planner將自動關閉未完成或未取消的工作項目。",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          text: "建立您的第一個工作事項",
          comic: {
            title: "工作事項是 Planner 中的基本單位。",
            description:
              "重新設計 Planner 使用者介面、重塑公司品牌或推出新的燃料噴射系統都是可能有子工作事項的工作事項範例。",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title: "撰寫筆記、文件或完整的知識庫。讓 Galileo（Planner 的 AI 助手）協助您開始",
        description:
          "頁面是 Planner 中的思考筆記空間。記下會議筆記，輕鬆格式化，嵌入工作事項，使用元件庫排版，並將它們全部保留在專案的上下文中。若要快速完成任何文件，可以使用快速鍵或按鈕來呼叫 Planner 的 AI Galileo。",
        primary_button: {
          text: "建立您的第一個頁面",
        },
      },
  ...
  self_hosted_maintenance_message: {
    planner_didnt_start_up_this_could_be_because_one_or_more_planner_services_failed_to_start:
      "Planner 未能啟動。這可能是因為一個或多個 Planner 服務啟動失敗。",
