export default {
  ...
  auth: {
    common: {
      ...
      new_to_planner: "Novo no Planner?",
  ...
  support: "Suporte",
  discord: "Discord",
  powered_by_planner_pages: "Desenvolvido por Planner Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "A maioria das coisas começa com um projeto no Planner.",
        cta: "Começar",
      },
      invite_team: {
  ...
  workspace_creation: {
    ...
    subheading: "Para começar a usar o Planner, você precisa criar ou entrar em um espaço de trabalho.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Bem-vindo ao Planner, estamos animados por tê-lo aqui. Crie seu primeiro projeto e rastreie seus itens de trabalho, e esta página se transformará em um espaço que ajuda você a progredir. Os administradores também verão itens que ajudam sua equipe a progredir.",
        primary_button: {
          text: "Construa seu primeiro projeto",
          comic: {
            title: "Tudo começa com um projeto no Planner",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Copie e salve esta chave secreta no Páginas do Planner. Você não pode ver esta chave depois de clicar em Fechar. Um arquivo CSV contendo a chave foi baixado.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Qualquer aplicativo que use este token não terá mais acesso aos dados do Planner. Esta ação não pode ser desfeita.",
          success: {
            title: "Sucesso!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "As APIs do Planner podem ser usadas para integrar seus dados no Planner com qualquer sistema externo. Crie um token para começar.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Comece criando um novo item de trabalho! Adicione detalhes e propriedades a ele. Explore mais no Planner para ver sua atividade.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "O Planner arquivará automaticamente os itens de trabalho que foram concluídos ou cancelados.",
        duration: "Arquivar automaticamente itens de trabalho que estão fechados por",
      },
      "auto-close": {
        title: "Fechar automaticamente itens de trabalho",
        description: "O Planner fechará automaticamente os itens de trabalho que não foram concluídos ou cancelados.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Os itens de trabalho são blocos de construção no Planner.",
            description:
              "Redesenhar a interface do usuário do Planner, reformular a marca da empresa ou lançar o novo sistema de injeção de combustível são exemplos de itens de trabalho que provavelmente têm subitens de trabalho.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Escreva uma nota, um documento ou uma base de conhecimento completa. Peça a Galileo, o assistente de IA do Planner, para ajudá-lo a começar",
        description:
          "As páginas são espaço para registrar pensamentos no Planner. Anote notas de reunião, formate-as facilmente, incorpore itens de trabalho, organize-os usando uma biblioteca de componentes e mantenha-os todos no contexto do seu projeto. Para facilitar qualquer documento, invoque Galileo, a IA do Planner, com um atalho ou o clique de um botão.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    planner_didnt_start_up_this_could_be_because_one_or_more_planner_services_failed_to_start:
      "O Planner não inicializou. Isso pode ser porque um ou mais serviços do Planner falharam ao iniciar.",
