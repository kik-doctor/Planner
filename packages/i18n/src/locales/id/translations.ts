export default {
  ...
  auth: {
    common: {
      ...
      new_to_planner: "Baru di Planner?",
  ...
  support: "Dukungan",
  discord: "Discord",
  powered_by_planner_pages: "Ditenagai oleh Planner Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        title: "Buat proyek",
        description: "Sebagian besar hal dimulai dengan proyek di Planner.",
        cta: "Mulai sekarang",
      },
      invite_team: {
      ...
      personalize_account: {
        title: "Jadikan Planner milik Anda.",
  ...
  workspace_creation: {
    ...
    subheading: "Untuk mulai menggunakan Planner, Anda perlu membuat atau bergabung dengan ruang kerja.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Selamat datang di Planner, kami sangat senang memiliki Anda di sini. Buat proyek pertama Anda dan lacak item kerja Anda, dan halaman ini akan berubah menjadi ruang yang membantu Anda berkembang. Admin juga akan melihat item yang membantu tim mereka berkembang.",
        primary_button: {
          text: "Bangun proyek pertama Anda",
          comic: {
            title: "Segalanya dimulai dengan proyek di Planner",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Salin dan simpan kunci rahasia ini di Halaman Planner. Anda tidak dapat melihat kunci ini setelah Anda menekan Tutup. File CSV yang berisi kunci telah diunduh.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Setiap aplikasi yang menggunakan token ini tidak akan memiliki akses ke data Planner. Tindakan ini tidak dapat dibatalkan.",
          success: {
            title: "Sukses!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "API Planner dapat digunakan untuk mengintegrasikan data Anda di Planner dengan sistem eksternal mana pun. Buat token untuk memulai.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Mulai dengan membuat item kerja baru! Tambahkan detail dan properti. Jelajahi lebih lanjut di Planner untuk melihat aktivitas Anda.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Planner akan mengarsipkan secara otomatis item kerja yang telah selesai atau dibatalkan.",
        duration: "Arsip otomatis item kerja yang ditutup selama",
      },
      "auto-close": {
        title: "Tutup otomatis item kerja",
        description: "Planner akan menutup secara otomatis item kerja yang belum selesai atau dibatalkan.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Item kerja adalah blok bangunan di Planner.",
            description:
              "Mendesain ulang UI Planner, Mengganti merek perusahaan, atau Meluncurkan sistem injeksi bahan bakar baru adalah contoh item kerja yang kemungkinan besar memiliki sub-item kerja.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Tulis catatan, dokumen, atau seluruh basis pengetahuan. Dapatkan Galileo, asisten AI Planner, untuk membantu Anda memulai",
        description:
          "Halaman adalah ruang pemikiran di Planner. Catat notul rapat, format dengan mudah, sertakan item kerja, tata letak menggunakan perpustakaan komponen, dan simpan semua di dalam konteks proyek Anda. Untuk menyelesaikan dokumen dengan cepat, panggil Galileo, AI Planner, dengan pintasan atau dengan mengklik tombol.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    planner_didnt_start_up_this_could_be_because_one_or_more_planner_services_failed_to_start:
      "Planner tidak berhasil dimulai. Ini bisa karena satu atau lebih layanan Planner gagal untuk dimulai.",
