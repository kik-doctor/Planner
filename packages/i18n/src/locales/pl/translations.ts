export default {
  ...
  support: "Wsparcie",
  discord: "Discord",
  powered_by_planner_pages: "Oparte na Planner Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Większość rzeczy zaczyna się od projektu w Planner.",
        cta: "Zacznij",
      },
      invite_team: {
        title: "Zaproś zespół",
