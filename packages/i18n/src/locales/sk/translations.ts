export default {
  ...
  support: "Podpora",
  discord: "Discord",
  powered_by_planner_pages: "Poháňa Planner Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Väčšina vecí začína projektom v Planner.",
        cta: "Začať",
      },
      invite_team: {
        title: "Pozvať tím",
  ...
  workspace_creation: {
    ...
    subheading: "Na používanie Planner musíte vytvoriť alebo sa pripojiť k pracovnému priestoru.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Vitajte v Planner, teší nás, že ste tu. Vytvorte prvý projekt, sledujte pracovné položky a táto stránka sa zmení na priestor pre váš pokrok. Správcovia tu uvidia aj položky pomáhajúce tímu.",
        primary_button: {
          text: "Vytvorte prvý projekt",
          comic: {
            title: "Všetko začína projektom v Planner",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Skopírujte a uložte tento kľúč do Planner Pages. Po zatvorení ho neuvidíte. CSV súbor s kľúčom bol stiahnutý.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Používajte API na integráciu Planner s externými systémami.",
      },
      webhooks: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Planner bude archivovať dokončené alebo zrušené položky.",
        duration: "Archivovať položky uzavreté dlhšie ako",
      },
      "auto-close": {
        title: "Automaticky uzatvárať položky",
        description: "Planner uzavrie neaktívne položky.",
  ...
  self_hosted_maintenance_message: {
    planner_didnt_start_up_this_could_be_because_one_or_more_planner_services_failed_to_start:
      "Planner sa nespustil. Toto môže byť spôsobené tým, že sa jedna alebo viac služieb Planner nepodarilo spustiť.",
