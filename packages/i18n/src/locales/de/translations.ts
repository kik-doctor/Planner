export default {
  ...
  auth: {
    common: {
      ...
      new_to_planner: "Neu bei Planner?",
  ...
  support: "Support",
  discord: "Discord",
  powered_by_planner_pages: "Bereitgestellt von Planner Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Die meisten Dinge beginnen mit einem Projekt in Planner.",
        cta: "Los geht’s",
      },
      invite_team: {
        title: "Team einladen",
      ...
      personalize_account: {
        title: "Personalisieren Sie Planner.",
  ...
  workspace_creation: {
    ...
    subheading: "Um Planner verwenden zu können, müssen Sie einen Arbeitsbereich erstellen oder beitreten.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Willkommen bei Planner, wir freuen uns, dass Sie hier sind. Erstellen Sie Ihr erstes Projekt, verfolgen Sie Arbeitselemente und diese Seite verwandelt sich in einen Ort für Ihren Fortschritt. Administratoren sehen hier zusätzlich teamrelevante Elemente.",
        primary_button: {
          text: "Erstes Projekt erstellen",
          comic: {
            title: "Alles beginnt mit einem Projekt in Planner",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Kopieren Sie diesen Schlüssel und fügen Sie ihn in Planner Pages ein. Nach dem Schließen können Sie ihn nicht mehr sehen. Eine CSV-Datei mit dem Schlüssel wurde heruntergeladen.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Verwenden Sie die API, um Planner mit externen Systemen zu integrieren.",
      },
      webhooks: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Planner wird Arbeitselemente automatisch archivieren, die abgeschlossen oder abgebrochen wurden.",
        duration: "Arbeitselemente automatisch archivieren, die seit",
      },
      "auto-close": {
        title: "Arbeitselemente automatisch schließen",
        description:
          "Planner wird Arbeitselemente automatisch schließen, die nicht abgeschlossen oder abgebrochen wurden.",
  ...
  self_hosted_maintenance_message: {
    planner_didnt_start_up_this_could_be_because_one_or_more_planner_services_failed_to_start:
      "Planner ist nicht gestartet. Dies könnte daran liegen, dass einer oder mehrere Planner-Services nicht starten konnten.",
