export default {
  ...
  auth: {
    common: {
      ...
      new_to_planner: "Ești nou în Planner?",
  ...
  support: "Suport",
  discord: "Discord",
  powered_by_planner_pages: "Oferit de Planner Documentație",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Majoritatea lucrurilor încep cu un proiect în Planner.",
        cta: "Începe acum",
      },
      invite_team: {
  ...
  workspace_creation: {
    ...
    subheading: "Pentru a începe să folosești Planner, trebuie să creezi sau să te alături unui spațiu de lucru.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Bine ai venit în Planner, suntem încântați să te avem aici. Creează primul tău proiect și urmărește activitățile, iar această pagină se va transforma într-un spațiu care te ajută să progresezi. Administratorii vor vedea și elementele care ajută echipa lor să progreseze.",
        primary_button: {
          text: "Creează primul tău proiect",
          comic: {
            title: "Totul începe cu un proiect în Planner",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Copiază și salvează această cheie secretă în Planner Documentație. Nu vei mai putea vedea această cheie după ce închizi. Un fișier CSV care conține cheia a fost descărcat.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Orice aplicație care folosește această cheie secretă nu va mai avea acces la datele Planner. Această acțiune este ireversibilă.",
          success: {
            title: "Succes!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "API-ul Planner poate fi folosit pentru a integra datele tale din Planner cu orice sistem extern. Creează o cheie secretă pentru a începe.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        title: "Nicio activitate încă",
        description:
          "Începe prin a crea o nouă activitate! Adaugă detalii și proprietăți. Explorează mai mult în Planner pentru a-ți vedea activitatea.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Planner va arhiva automat activitățile care au fost finalizate sau anulate.",
        duration: "Auto-arhivează activitățile finalizate de",
      },
      "auto-close": {
        title: "Închide automat activitățile",
        description: "Planner va închide automat activitățile care nu au fost finalizate sau anulate.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Activitățile sunt elemente de bază în Planner.",
            description:
              "Reproiectarea interfeței PlannerPlannerPlanner, modernizarea imaginii companiei sau lansarea noului sistem de injecție sunt exemple de activități care au, cel mai probabil, sub-activități.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Scrie o notiță, un document sau o bază completă de cunoștințe. Folosește-l pe Galileo, Inteligența Artificială a Planner, ca să te ajute să începi",
        description:
          "Documentația e spațiul în care îți notezi gândurile în Planner. Ia notițe de la ședințe, formatează-le ușor, inserează activități, așază-le folosind o bibliotecă de componente și păstrează-le pe toate în contextul proiectului tău. Pentru a redacta rapid orice document, apelează la Galileo, Inteligența Artificială a Planner, cu un shortcut sau un click.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    planner_didnt_start_up_this_could_be_because_one_or_more_planner_services_failed_to_start:
      "Planner nu a pornit. Aceasta ar putea fi din cauza că unul sau mai multe servicii Planner au eșuat să pornească.",
