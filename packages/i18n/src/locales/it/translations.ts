export default {
  ...
  support: "Supporto",
  discord: "Discord",
  powered_by_planner_pages: "Supportato da Planner Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "La maggior parte delle cose inizia con un progetto in Planner.",
        cta: "Inizia",
      },
      invite_team: {
  ...
  workspace_creation: {
    ...
    subheading: "Per iniziare a usare Planner, devi creare o unirti a uno spazio di lavoro.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Benvenuto in Planner, siamo entusiasti di averti qui. Crea il tuo primo progetto e traccia i tuoi elementi di lavoro, e questa pagina si trasformerà in uno spazio che ti aiuta a progredire. Gli amministratori vedranno anche elementi che aiutano il team a progredire.",
        primary_button: {
          text: "Crea il tuo primo progetto",
          comic: {
            title: "Tutto inizia con un progetto in Planner",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Copia e salva questa chiave segreta in Planner Pages. Non potrai vederla dopo aver cliccato Chiudi. È stato scaricato un file CSV contenente la chiave.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Qualsiasi applicazione che utilizza questo token non avrà più accesso ai dati di Planner. Questa azione non può essere annullata.",
          success: {
            title: "Successo!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "Le API di Planner possono essere utilizzate per integrare i tuoi dati in Planner con qualsiasi sistema esterno. Crea un token per iniziare.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Inizia creando un nuovo elemento di lavoro! Aggiungi dettagli e proprietà ad esso. Esplora Planner per vedere la tua attività.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Planner archiverà automaticamente gli elementi di lavoro che sono stati completati o annullati.",
        duration: "Archivia automaticamente gli elementi di lavoro chiusi per",
      },
      "auto-close": {
        title: "Chiudi automaticamente gli elementi di lavoro",
        description:
          "Planner chiuderà automaticamente gli elementi di lavoro che non sono stati completati o annullati.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Gli elementi di lavoro sono i mattoni fondamentali in Planner.",
            description:
              "Ridisegna l'interfaccia di Planner, rebranding dell'azienda o lancia il nuovo sistema di iniezione del carburante sono esempi di elementi di lavoro che probabilmente hanno sotto-elementi.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Scrivi una nota, un documento o una vera e propria base di conoscenza. Fai partire Galileo, l'assistente AI di Planner, per aiutarti a iniziare",
        description:
          "Le pagine sono spazi per appunti in Planner. Prendi note durante le riunioni, formattale facilmente, inserisci elementi di lavoro, disponili usando una libreria di componenti e tienili tutti nel contesto del tuo progetto. Per velocizzare qualsiasi documento, invoca Galileo, l'IA di planner, con una scorciatoia o con il clic di un pulsante.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    planner_didnt_start_up_this_could_be_because_one_or_more_planner_services_failed_to_start:
      "Planner non si è avviato. Questo potrebbe essere dovuto al fatto che uno o più servizi Planner non sono riusciti ad avviarsi.",
