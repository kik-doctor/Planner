export default {
  ...
  auth: {
    common: {
      ...
      new_to_planner: "Planner'e yeni mi geldiniz?",
  ...
  support: "Destek",
  discord: "Discord",
  powered_by_planner_pages: "Planner Pages tarafından desteklenmektedir",
  ...
  home: {
    empty: {
      ...
      create_project: {
        title: "Proje oluştur",
        description: "Çoğu şey Planner'de bir projeyle başlar.",
        cta: "Başla",
      },
      invite_team: {
      ...
      personalize_account: {
        title: "Planner'yi kendinize özelleştirin.",
  ...
  workspace_creation: {
    ...
    subheading: "Planner'i kullanmaya başlamak için bir çalışma alanı oluşturmalı veya katılmalısınız.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Planner'e hoş geldiniz, sizi aramızda görmekten heyecan duyuyoruz. İlk projenizi oluşturun ve iş öğelerinizi takip edin, bu sayfa ilerlemenize yardımcı olacak bir alana dönüşecek. Yöneticiler ayrıca ekiplerinin ilerlemesine yardımcı olacak öğeler görecek.",
        primary_button: {
          text: "İlk projenizi oluşturun",
          comic: {
            title: "Planner'de her şey bir projeyle başlar",
            description:
  ...
  workspace_settings: {
    ...
    copy_key:
      "Bu gizli anahtarı Planner Pages'e kopyalayıp kaydedin. Kapat düğmesine bastıktan sonra bu anahtarı göremezsiniz. Anahtar içeren bir CSV dosyası indirildi.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description: "Bu token'ı kullanan uygulamalar artık Planner verilerine erişemeyecek. Bu işlem geri alınamaz.",
          success: {
            title: "Başarılı!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Planner API'lerini harici sistemlere entegre etmek için bir token oluşturun.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Yeni bir iş öğesi oluşturarak başlayın! Detaylar ve özellikler ekleyin. Aktivitenizi görmek için Planner'de daha fazlasını keşfedin.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Planner, tamamlanan veya iptal edilen iş öğelerini otomatik arşivleyecek.",
        duration: "Şu süre kapalı kalan iş öğelerini otomatik arşivle",
      },
      "auto-close": {
        title: "İş öğelerini otomatik kapat",
        description: "Planner, tamamlanmamış veya iptal edilmemiş iş öğelerini otomatik kapatacak.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "İş öğeleri Planner'de yapı taşlarıdır.",
            description:
              "Planner UI'yi yeniden tasarlamak, şirketi yeniden markalaştırmak veya yeni yakıt enjeksiyon sistemini başlatmak, muhtemelen alt iş öğeleri olan iş öğesi örnekleridir.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Bir not, belge veya tam bir bilgi bankası yazın. Planner'in AI asistanı Galileo'nun başlamanıza yardımcı olmasını sağlayın",
        description:
          "Sayfalar Planner'de düşüncelerinizi döktüğünüz alanlardır. Toplantı notları alın, kolayca biçimlendirin, iş öğelerini yerleştirin, bir bileşen kitaplığı kullanarak düzenleyin ve hepsini proje bağlamınızda tutun. Herhangi bir belgeyi hızlıca tamamlamak için bir kısayol veya düğme ile Planner'in AI'sı Galileo'yu çağırın.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    planner_didnt_start_up_this_could_be_because_one_or_more_planner_services_failed_to_start:
      "planner başlatılamadı. Bu, bir veya daha fazla Planner servisinin başlatılamaması nedeniyle olabilir.",
