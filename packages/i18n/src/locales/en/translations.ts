export default {
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Most things start with a project in Planner.",
        cta: "Get started",
      },
      invite_team: {
  ...
  workspace_creation: {
    ...
    subheading: "To start using Planner, you need to create or join a workspace.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Welcome to Planner, we are excited to have you here. Create your first project and track your work items, and this page will transform into a space that helps you progress. Admins will also see items which help their team progress.",
        primary_button: {
          text: "Build your first project",
          comic: {
            title: "Everything starts with a project in Planner",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Copy and save this secret key in Planner Pages. You can't see this key after you hit Close. A CSV file containing the key has been downloaded.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          ...
          description:
            "Any application using this token will no longer have the access to Planner data. This action cannot be undone.",
          success: {
            title: "Success!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "Planner APIs can be used to integrate your data in Planner with any external system. Create a token to get started.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Get started by creating a new work item! Add details and properties to it. Explore more in Planner to see your activity.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Planner will auto archive work items that have been completed or canceled.",
        duration: "Auto-archive work items that are closed for",
      },
      "auto-close": {
        title: "Auto-close work items",
        description: "Planner will automatically close work items that haven't been completed or canceled.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Work items are building blocks in Planner.",
            description:
              "Redesign the Planner UI, Rebrand the company, or Launch the new fuel injection system are examples of work items that likely have sub-work items.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title:
          "Write a note, a doc, or a full knowledge base. Get Galileo, Planner's AI assistant, to help you get started",
        description:
          "Pages are thoughts potting space in Planner. Take down meeting notes, format them easily, embed work items, lay them out using a library of components, and keep them all in your project's context. To make short work of any doc, invoke Galileo, Planner's AI, with a shortcut or the click of a button.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    planner_didnt_start_up_this_could_be_because_one_or_more_planner_services_failed_to_start:
      "Planner didn't start up. This could be because one or more Planner services failed to start.",
  ...
  power_k: {
    ...
    help_actions: {
      ...
      open_planner_documentation: "Open Planner documentation",
