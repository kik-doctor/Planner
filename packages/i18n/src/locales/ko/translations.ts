export default {
  ...
  auth: {
    common: {
      ...
      new_to_planner: "Planner을 처음 사용하시나요?",
  ...
  support: "지원",
  discord: "디스코드",
  powered_by_planner_pages: "Planner Pages 제공",
  ...
  home: {
    empty: {
      ...
      create_project: {
        title: "프로젝트 생성",
        description: "Planner에서 대부분의 작업은 프로젝트로 시작됩니다.",
        cta: "시작하기",
      },
      invite_team: {
        title: "팀 초대",
  ...
  workspace_creation: {
    heading: "작업 공간 생성",
    subheading: "Planner을 사용하려면 작업 공간을 생성하거나 참여해야 합니다.",
    form: {
      name: {
        label: "작업 공간 이름",
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Planner에 오신 것을 환영합니다. 첫 번째 프로젝트를 생성하고 작업 항목을 추적하면 이 페이지가 진행 상황을 돕는 공간으로 변합니다. 관리자도 팀의 진행을 돕는 항목을 볼 수 있습니다.",
        primary_button: {
          text: "첫 번째 프로젝트 생성",
          comic: {
            title: "Planner에서 모든 것은 프로젝트로 시작됩니다",
  ...
  workspace_settings: {
    ...
    key_created: "키 생성됨",
    copy_key:
      "이 비밀 키를 Planner Pages에 복사하고 저장하세요. 닫기 버튼을 누른 후에는 이 키를 볼 수 없습니다. 키가 포함된 CSV 파일이 다운로드되었습니다.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          title: "API 토큰 삭제",
          description:
            "이 토큰을 사용하는 애플리케이션은 더 이상 Planner 데이터에 접근할 수 없습니다. 이 작업은 되돌릴 수 없습니다.",
          success: {
            title: "성공!",
    ...
    empty_state: {
      api_tokens: {
        title: "생성된 API 토큰 없음",
        description:
          "Planner API를 사용하여 Planner의 데이터를 외부 시스템과 통합할 수 있습니다. 토큰을 생성하여 시작하세요.",
      },
      webhooks: {
        title: "추가된 웹훅 없음",
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        title: "아직 활동 없음",
        description:
          "새 작업 항목을 생성하여 시작하세요! 세부 정보와 속성을 추가하세요. Planner에서 더 많은 것을 탐색하여 활동을 확인하세요.",
      },
      assigned: {
        title: "할당된 작업 항목 없음",
        description: "할당된 작업 항목을 여기에서 추적할 수 있습니다.",
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Planner은 완료되거나 취소된 작업 항목을 자동으로 보관합니다.",
        duration: "다음 기간 동안 닫힌 작업 항목 자동 보관",
      },
      "auto-close": {
        title: "작업 항목 자동 닫기",
        description: "Planner은 완료되거나 취소되지 않은 작업 항목을 자동으로 닫습니다.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          text: "첫 번째 작업 항목 생성",
          comic: {
            title: "작업 항목은 Planner의 구성 요소입니다.",
            description:
              "Planner UI 재설계, 회사 리브랜딩 또는 새로운 연료 주입 시스템 출시와 같은 작업 항목은 하위 작업 항목이 있을 가능성이 큽니다.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title: "메모, 문서 또는 전체 지식 기반을 작성하세요. Galileo, Planner의 AI 도우미가 시작을 도와줍니다",
        description:
          "페이지는 Planner에서 생각을 정리하는 공간입니다. 회의 메모를 작성하고, 쉽게 형식을 지정하고, 작업 항목을 포함하고, 구성 요소 라이브러리를 사용하여 레이아웃을 작성하고, 모든 것을 프로젝트의 맥락에서 유지하세요. 문서를 빠르게 작성하려면 단축키나 버튼 클릭으로 Galileo, planner의 AI를 호출하세요.",
        primary_button: {
          text: "첫 번째 페이지 생성",
        },
      },
  ...
  self_hosted_maintenance_message: {
    planner_didnt_start_up_this_could_be_because_one_or_more_planner_services_failed_to_start:
      "Planner이 시작되지 않았습니다. 이는 하나 이상의 Planner 서비스가 시작에 실패했기 때문일 수 있습니다.",
