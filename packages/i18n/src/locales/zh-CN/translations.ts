export default {
  ...
  support: "支持",
  discord: "Discord",
  powered_by_planner_pages: "由Planner Pages提供支持",
  ...
  home: {
    empty: {
      ...
      create_project: {
        title: "创建项目",
        description: "在Planner中，大多数事情都从项目开始。",
        cta: "开始使用",
      },
      invite_team: {
        title: "邀请您的团队",
  ...
  workspace_creation: {
    heading: "创建您的工作区",
    subheading: "要开始使用 Planner，您需要创建或加入一个工作区。",
    form: {
      name: {
        label: "为您的工作区命名",
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        title: "项目、活动和指标概览",
        description:
          "欢迎使用 Planner，我们很高兴您能来到这里。创建您的第一个项目并跟踪您的工作项，这个页面将转变为帮助您进展的空间。管理员还将看到帮助团队进展的项目。",
        primary_button: {
          text: "构建您的第一个项目",
          comic: {
            title: "在 Planner 中一切都从项目开始",
  ...
  workspace_settings: {
    ...
    key_created: "密钥已创建",
    copy_key: "复制并将此密钥保存在 Planner Pages 中。关闭后您将无法看到此密钥。包含密钥的 CSV 文件已下载。",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          title: "删除 API 令牌",
          description: "使用此令牌的任何应用程序将无法再访问 Planner 数据。此操作无法撤消。",
          success: {
            title: "成功！",
            message: "API 令牌已成功删除",
          },
    ...
    empty_state: {
      api_tokens: {
        title: "尚未创建 API 令牌",
        description: "Planner API 可用于将您在 Planner 中的数据与任何外部系统集成。创建令牌以开始使用。",
      },
      webhooks: {
        title: "尚未添加 webhook",
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        title: "尚无活动",
        description: "通过创建新工作项开始！为其添加详细信息和属性。在 Planner 中探索更多内容以查看您的活动。",
      },
      assigned: {
        title: "没有分配给您的工作项",
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        title: "自动归档已关闭的工作项",
        description: "Planner 将自动归档已完成或已取消的工作项。",
        duration: "自动归档已关闭",
      },
      "auto-close": {
        title: "自动关闭工作项",
        description: "Planner 将自动关闭尚未完成或取消的工作项。",
        duration: "自动关闭不活跃",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          text: "创建您的第一个工作项",
          comic: {
            title: "工作项是 Planner 中的基本构建块。",
            description: "重新设计 Planner 界面、重塑公司品牌或启动新的燃料喷射系统都是可能包含子工作项的工作项示例。",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title: "写笔记、文档或完整的知识库。让 Planner 的 AI 助手 Galileo 帮助您开始",
        description:
          "页面是 Planner 中的思维记录空间。记录会议笔记，轻松格式化，嵌入工作项，使用组件库进行布局，并将它们全部保存在项目上下文中。要快速完成任何文档，可以通过快捷键或点击按钮调用 Planner 的 AI Galileo。",
        primary_button: {
          text: "创建您的第一个页面",
        },
      },
  ...
  self_hosted_maintenance_message: {
    planner_didnt_start_up_this_could_be_because_one_or_more_planner_services_failed_to_start:
      "Planner 未能启动。这可能是因为一个或多个 Planner 服务启动失败。",
