export default {
  ...
  auth: {
    common: {
      ...
      new_to_planner: "Lần đầu sử dụng Planner?",
  ...
  support: "Hỗ trợ",
  discord: "Discord",
  powered_by_planner_pages: "Được hỗ trợ bởi Planner Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        title: "Tạo dự án",
        description: "Trong Planner, hầu hết mọi thứ đều bắt đầu từ dự án.",
        cta: "Bắt đầu",
      },
      invite_team: {
      ...
      personalize_account: {
        title: "Cá nhân hóa Planner cho bạn",
    ...
    new_at_planner: {
      title: "Tính năng mới của Planner",
    },
    quick_tutorial: {
  ...
  workspace_creation: {
    ...
    subheading: "Để bắt đầu với Planner, bạn cần tạo hoặc tham gia một không gian làm việc.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Chào mừng đến với Planner, chúng tôi rất vui khi bạn ở đây. Tạo dự án đầu tiên của bạn và theo dõi mục công việc, trang này sẽ trở thành không gian giúp bạn tiến triển. Quản trị viên cũng sẽ thấy dự án giúp nhóm tiến triển.",
        primary_button: {
          text: "Xây dựng dự án đầu tiên của bạn",
          comic: {
            title: "Trong Planner, mọi thứ đều bắt đầu với dự án",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Sao chép và lưu khóa này trong Planner Pages. Bạn sẽ không thể thấy khóa này sau khi đóng. Tệp CSV chứa khóa đã được tải xuống.",
    ...
    settings: {
      ...
      api_tokens: {
        ...
        delete: {
          title: "Xóa token API",
          description:
            "Bất kỳ ứng dụng nào sử dụng token này sẽ không thể truy cập dữ liệu Planner nữa. Hành động này không thể hoàn tác.",
          success: {
            title: "Thành công!",
    ...
    empty_state: {
      api_tokens: {
        ...
        description:
          "API Planner có thể được sử dụng để tích hợp dữ liệu Planner của bạn với bất kỳ hệ thống bên ngoài nào. Tạo token để bắt đầu.",
      },
      webhooks: {
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Bắt đầu bằng cách tạo mục công việc mới! Thêm chi tiết và thuộc tính cho nó. Khám phá thêm trong Planner để xem hoạt động của bạn.",
      },
      assigned: {
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Planner sẽ tự động lưu trữ các mục công việc đã hoàn thành hoặc đã hủy.",
        duration: "Tự động lưu trữ đã đóng",
      },
      "auto-close": {
        title: "Tự động đóng mục công việc",
        description: "Planner sẽ tự động đóng các mục công việc chưa hoàn thành hoặc hủy.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Mục công việc là khối xây dựng cơ bản trong Planner.",
            description:
              "Thiết kế lại giao diện Planner, định vị lại thương hiệu công ty hoặc ra mắt hệ thống phun nhiên liệu mới đều là ví dụ về mục công việc có thể chứa các mục công việc con.",
          },
        },
      },
      no_archived_issues: {
  ...
  project_page: {
    empty_state: {
      general: {
        title: "Viết ghi chú, tài liệu hoặc cơ sở kiến thức đầy đủ. Để trợ lý AI Galileo của Planner giúp bạn bắt đầu",
        description:
          "Trang là không gian ghi lại suy nghĩ trong Planner. Ghi lại các ghi chú cuộc họp, định dạng dễ dàng, nhúng mục công việc, sử dụng thư viện thành phần để bố cục và lưu tất cả trong ngữ cảnh dự án. Để hoàn thành nhanh bất kỳ tài liệu nào, bạn có thể gọi AI Galileo của Planner thông qua phím tắt hoặc nhấp nút.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    planner_didnt_start_up_this_could_be_because_one_or_more_planner_services_failed_to_start:
      "Planner không khởi động được. Điều này có thể do một hoặc nhiều dịch vụ Planner không khởi động được.",
