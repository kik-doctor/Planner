export default {
  ...
  auth: {
    common: {
      ...
      new_to_planner: "Впервые в Planner?",
  ...
  support: "Поддержка",
  discord: "Discord",
  powered_by_planner_pages: "Работает на Planner Pages",
  ...
  home: {
    empty: {
      ...
      create_project: {
        ...
        description: "Большинство вещей начинаются с проекта в Planner.",
        cta: "Начать",
      },
      invite_team: {
      ...
      personalize_account: {
        title: "Персонализируйте Planner",
  ...
  workspace_creation: {
    ...
    subheading: "Чтобы начать использовать Planner, создайте или присоединитесь к рабочему пространству.",
    form: {
      name: {
  ...
  workspace_dashboard: {
    empty_state: {
      general: {
        ...
        description:
          "Добро пожаловать в Planner! Создайте первый проект и отслеживайте рабочие элементы - эта страница станет вашим рабочим пространством. Администраторы также увидят элементы для управления командой.",
        primary_button: {
          text: "Создать первый проект",
          comic: {
            title: "Всё начинается с проекта в Planner",
  ...
  workspace_settings: {
    ...
    copy_key:
      "Скопируйте и сохраните секретный ключ в Planner Pages. После закрытия ключ будет недоступен. CSV-файл с ключом был скачан.",
    ...
    empty_state: {
      api_tokens: {
        ...
        description: "Используйте API Planner для интеграции с внешними системами. Создайте тоекен чтобы начать.",
      },
      webhooks: {
        title: "Нет вебхуков",
  ...
  profile: {
    ...
    empty_state: {
      activity: {
        ...
        description:
          "Создайте первый рабочий элемент для начала работы! Добавьте детали и свойства рабочего элемента. Исследуйте больше в Planner, чтобы увидеть вашу активность.",
      },
      assigned: {
        title: "Нет назначенных рабочих элементов",
        description: "Здесь отображаются рабочие элементы, назначенные вам.",
  ...
  project_settings: {
    ...
    automations: {
      ...
      "auto-archive": {
        ...
        description: "Planner будет автоматически архивировать рабочие элементы, которые были завершены или отменены.",
        duration: "Автоархивация рабочих элементов, которые закрыты в течение",
      },
      "auto-close": {
        title: "Автоматическое закрытие рабочих элементов",
        description: "Planner будет автоматически закрывать рабочие элементы, которые не были завершены или отменены.",
    ...
    empty_state: {
      no_issues: {
        ...
        primary_button: {
          ...
          comic: {
            title: "Рабочие элементы - строительные блоки Planner",
            description:
  ...
  project_page: {
    empty_state: {
      general: {
        title: "Создавайте заметки, документы или базу знаний. Используйте Galileo, ИИ-помощник Planner.",
        description:
          "Страницы - пространство для организации мыслей в Planner. Делайте заметки, форматируйте текст, встраивайте рабочие элементы, используйте компоненты. Для быстрого создания документов используйте Galileo через горячие клавиши или кнопку.",
        primary_button: {
  ...
  self_hosted_maintenance_message: {
    planner_didnt_start_up_this_could_be_because_one_or_more_planner_services_failed_to_start:
      "Planner не запустился. Это может быть из-за того, что один или несколько сервисов Planner не смогли запуститься.",
