...
SPECTACULAR_SETTINGS = {
    ...
    # ========================================================================
    "TITLE": "The Planner REST API",
    "DESCRIPTION": (
        "The Planner REST API\n\n"
        "Visit our quick start guide and full API documentation at "
        "[developers.planner.oneworkspacex.com](https://developers.planner.oneworkspacex.com/api-reference/introduction)."
    ),
    "CONTACT": {
        "name": "planner",
        "url": "https://planner.oneworkspacex.com",
        "email": "hello@oneworkspacex.com",
    },
    "VERSION": "0.0.1",
    "LICENSE": {
        "name": "GNU AGPLv3",
        "url": "https://github.com/kik-doctor/Planner/blob/preview/LICENSE.txt",
    },
    # ========================================================================
    ...
    # ========================================================================
    "PREPROCESSING_HOOKS": [
        "planner.utils.openapi.hooks.preprocess_filter_api_v1_paths",
    ],
    # ========================================================================
    ...
    "SERVERS": [
        ...
        {"url": "https://api.planner.oneworkspacex.com", "description": "Production"},
    ],
    # ========================================================================
    # API Tag Definitions
    # ========================================================================
    ...
    "AUTHENTICATION_WHITELIST": [
        "planner.api.middleware.api_authentication.APIKeyAuthentication",
    ],
    # ========================================================================
    ...
    "ENUM_NAME_OVERRIDES": {
        "ModuleStatusEnum": "planner.db.models.module.ModuleStatus",
        "IntakeWorkItemStatusEnum": "planner.db.models.intake.IntakeIssueStatus",
    },
}
