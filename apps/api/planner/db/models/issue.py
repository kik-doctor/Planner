...
# Module imports
from planner.utils.html_processor import strip_tags
from planner.db.mixins import SoftDeletionManager
from planner.utils.exception_logger import log_exception
from .project import ProjectBaseModel
from planner.utils.uuid import convert_uuid_to_integer
from .description import Description
from planner.db.mixins import ChangeTrackerMixin
...
class Issue(ProjectBaseModel):
    ...
    def save(self, *args, **kwargs):
        if self.state is None:
            try:
                from planner.db.models import State
