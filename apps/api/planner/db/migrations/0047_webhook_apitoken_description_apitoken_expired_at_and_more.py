...
import planner.db.models.api
import planner.db.models.webhook
import uuid
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.URLField(
                        validators=[
                            planner.db.models.webhook.validate_schema,
                            planner.db.models.webhook.validate_domain,
                        ]
                    ),
                ),
                ...
                (
                    "secret_key",
                    models.CharField(
                        default=planner.db.models.webhook.generate_token,
                        max_length=255,
                    ),
                ),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                db_index=True,
                default=planner.db.models.api.generate_token,
                max_length=255,
                unique=True,
            ),
        ),
