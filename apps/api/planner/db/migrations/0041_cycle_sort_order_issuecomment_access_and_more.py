...
import planner.db.models.exporter
import planner.db.models.project
import uuid
import random
import string
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "token",
                    models.CharField(
                        default=planner.db.models.exporter.generate_token,
                        max_length=255,
                        unique=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        db_index=True,
                        default=planner.db.models.project.get_anchor,
                        max_length=255,
                        unique=True,
                    ),
                ),
                ...
                (
                    "views",
                    models.JSONField(
                        default=planner.db.models.project.get_default_views
                    ),
                ),
                (
                    "created_by",
