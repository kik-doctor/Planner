...
from planner.license.models import InstanceConfiguration
from planner.license.api.serializers import InstanceConfigurationSerializer
from planner.license.utils.encryption import encrypt_data
from planner.utils.cache import cache_response, invalidate_cache
from planner.license.utils.instance_value import get_email_configuration
...
class EmailCredentialCheckEndpoint(BaseAPIView):
    def post(self, request):
        ...
        subject = "Email Notification from Planner"
        message = "This is a sample email notification sent from Planner application."
        # Send the email
        try:
