...
# Module imports
from planner.db.models import BaseModel
...
class Instance(BaseModel):
    ...
    edition = models.CharField(max_length=255, default=InstanceEdition.PLANNER_COMMUNITY.value)
    ...
    # is setup done
    is_setup_done = models.BooleanField(default=True)
    # signup screen
