...
# Module imports
from planner.license.models import Instance, InstanceEdition
from planner.license.bgtasks.tracer import instance_traces
    ...
    def check_for_latest_version(self, fallback_version):
        try:
            response = requests.get(
                "https://api.github.com/repos/kik-doctor/planner/releases/latest",
                timeout=10,
            )
    ...
    def handle(self, *args, **options):
        ...
        if instance is None:
            ...
            instance = Instance.objects.create(
                instance_name="Planner Community Edition",
                instance_id=secrets.token_hex(12),
                current_version=current_version,
                latest_version=latest_version,
                last_checked_at=timezone.now(),
                is_test=os.environ.get("IS_TEST", "0") == "1",
                edition=InstanceEdition.PLANNER_COMMUNITY.value,
            )
            ...
            instance.edition = InstanceEdition.PLANNER_COMMUNITY.value
            instance.save()
