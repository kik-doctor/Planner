...
# Module imports
from planner.db.models import Project, ProjectMemberInvite, User
...
def project_invitation(email, project_id, token, current_site, invitor):
    try:
        ...
        subject = f"{user.first_name or user.display_name or user.email} invited you to join {project.name} on planner"
