import pytest
from planner.db.models import Project, ProjectMember, Issue, FileAsset
from unittest.mock import patch, MagicMock
from planner.bgtasks.copy_s3_object import (
...
class TestCopyS3Objects:
    ...
    @patch("planner.bgtasks.copy_s3_object.S3Storage")
    def test_copy_s3_objects_of_description_and_assets(
        ...
        with patch("planner.bgtasks.copy_s3_object.sync_with_external_service") as mock_sync:
