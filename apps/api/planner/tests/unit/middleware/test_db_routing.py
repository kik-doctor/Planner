...
from planner.middleware.db_routing import ReadReplicaRoutingMiddleware
...
class TestReadReplicaRoutingMiddleware:
    ...
    @patch("planner.middleware.db_routing.set_use_read_replica")
    @patch("planner.middleware.db_routing.clear_read_replica_context")
