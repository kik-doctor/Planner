...
from planner.db.models import Webhook, WebhookLog
from planner.db.models.webhook import validate_domain, validate_schema
...
class WebhookSerializer(DynamicBaseSerializer):
    ...
    def create(self, validated_data):
        ...
        disallowed_domains = ["planner.oneworkspacex.com"]  # Add your disallowed domains here
        if request:
