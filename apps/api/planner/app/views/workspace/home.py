...
from planner.db.models.workspace import WorkspaceHomePreference
from planner.app.permissions import allow_permission, ROLE
from planner.db.models import Workspace
from planner.app.serializers.workspace import WorkspaceHomePreferenceSerializer
...
class WorkspaceHomePreferenceViewSet(BaseAPIView):
    ...
    def get(self, request, slug):
        ...
        keys = [
            ...
            if key not in ["quick_tutorial", "new_at_planner"]
        ]
