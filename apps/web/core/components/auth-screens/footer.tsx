...
import { AccentureLogo, DolbyLogo, SonyLogo, ZerodhaLogo } from "@planner/propel/icons";
...
export function AuthFooter() {
  return (
    <div className="flex flex-col items-center gap-6">
      <span className="text-sm text-custom-text-300 whitespace-nowrap">Join 10,000+ teams building with Planner</span>
