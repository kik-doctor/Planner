...
const APP_TITLE = "Planner Publish | Make your Planner boards public with one-click";
const APP_DESCRIPTION =
  "Planner Publish is a customer feedback management tool built on top of planner.oneworkspacex.com";
...
export const meta: Route.MetaFunction = () => [
  ...
  { property: "og:url", content: "https://sites.planner.oneworkspacex.com/" },
  {
    name: "keywords",
    content:
